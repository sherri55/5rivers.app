 ...
 */
export async function resizeForLLM(img: RawImage): Promise<RawImage> {
  ...
  try {
    ...
    console.log(
      `[img] resized: ${meta.width}×${meta.height} ${meta.format} ` +
...
export async function resizeAllForLLM(images: RawImage[]): Promise<RawImage[]> {
