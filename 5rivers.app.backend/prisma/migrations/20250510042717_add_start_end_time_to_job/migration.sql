/*
  ...
  - You are about to drop the column `dispatchType` on the `Job` table. All the data in the column will be lost.
  - You are about to drop the column `driverPay` on the `Job` table. All the data in the column will be lost.
  - You are about to drop the column `driverRate` on the `Job` table. All the data in the column will be lost.
  - You are about to drop the column `estimatedFuel` on the `Job` table. All the data in the column will be lost.
  - You are about to drop the column `estimatedRevenue` on the `Job` table. All the data in the column will be lost.
