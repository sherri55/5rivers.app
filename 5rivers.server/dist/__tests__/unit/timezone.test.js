...
describe('parseTimeInputToUTC', () => {
    ...
    const sameInstant = (a, expected) => {
        expect(a).not.toBeNull();
        expect(a.toISOString()).toBe(new Date(expected).toISOString());
    };
    it('returns null for empty / whitespace / null / undefined', () => {
        expect((0, timezone_1.parseTimeInputToUTC)('2026-04-20', null)).toBeNull();
        expect((0, timezone_1.parseTimeInputToUTC)('2026-04-20', undefined)).toBeNull();
        expect((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '')).toBeNull();
        expect((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '   ')).toBeNull();
    });
    it('passes through a full UTC ISO string with Z', () => {
        sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '2026-04-20T16:00:00.000Z'), '2026-04-20T16:00:00.000Z');
    });
    it('passes through an ISO string with explicit offset', () => {
        sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '2026-04-20T12:00:00-04:00'), '2026-04-20T16:00:00.000Z');
    });
    describe('Eastern-time inputs', () => {
        // April is EDT (UTC-4). 12:00 PM Eastern = 16:00 UTC.
        it('"12:00" (24h) → 16:00 UTC during EDT', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '12:00'), '2026-04-20T16:00:00.000Z');
        });
        it('"7:00 AM" → 11:00 UTC during EDT', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '7:00 AM'), '2026-04-20T11:00:00.000Z');
        });
        it('"12:00 AM" (midnight) → 04:00 UTC', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '12:00 AM'), '2026-04-20T04:00:00.000Z');
        });
        it('"12:00 PM" (noon) → 16:00 UTC', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '12:00 PM'), '2026-04-20T16:00:00.000Z');
        });
        it('"5:30 PM" → 21:30 UTC', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '5:30 PM'), '2026-04-20T21:30:00.000Z');
        });
        it('"22:30" (24h) → 02:30 next-day UTC', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20', '22:30'), '2026-04-21T02:30:00.000Z');
        });
        it('strips a trailing time component from a date-only jobDate', () => {
            ...
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-04-20T00:00:00.000Z', '7:00 AM'), '2026-04-20T11:00:00.000Z');
        });
    });
    describe('DST boundary handling', () => {
        ...
        it('first weekday of EST (Jan): noon Eastern = 17:00 UTC (UTC-5)', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-01-15', '12:00 PM'), '2026-01-15T17:00:00.000Z');
        });
        it('summer (EDT, Jul): noon Eastern = 16:00 UTC (UTC-4)', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-07-15', '12:00 PM'), '2026-07-15T16:00:00.000Z');
        });
        it('day after spring-forward (Mar 9 2026): noon Eastern = 16:00 UTC (EDT)', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-03-09', '12:00 PM'), '2026-03-09T16:00:00.000Z');
        });
        it('day after fall-back (Nov 2 2026): noon Eastern = 17:00 UTC (EST)', () => {
            sameInstant((0, timezone_1.parseTimeInputToUTC)('2026-11-02', '12:00 PM'), '2026-11-02T17:00:00.000Z');
        });
    });
});
describe('nowUTC / nowEastern / formatTimeEastern', () => {
    ...
    it('formatTimeEastern formats a UTC date in Eastern HH:MM', () => {
        ...
        const formatted = (0, timezone_1.formatTimeEastern)(utc);
