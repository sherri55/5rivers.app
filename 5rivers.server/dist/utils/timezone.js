...
exports.SQL_TODAY_EASTERN = exports.SQL_NOW_EASTERN = exports.SQL_NOW_UTC = void 0;
exports.nowUTC = nowUTC;
exports.nowEastern = nowEastern;
exports.todayEastern = todayEastern;
exports.parseTimeInputToUTC = parseTimeInputToUTC;
exports.utcToEastern = utcToEastern;
exports.formatTimeEastern = formatTimeEastern;
 ...
 */
function parseTimeInputToUTC(jobDate, timeStr) {
 ...
 */
function easternToUTC(easternIso) {
 ...
 */
function formatTimeEastern(utcDate) {
    if (!utcDate)
        return '';
...
exports.SQL_NOW_UTC = `GETUTCDATE()`;
